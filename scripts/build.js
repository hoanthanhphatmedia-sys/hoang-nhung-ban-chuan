...
function buildThankYou() {
  ...
  <section class="page-hero">
    ...
    <p>Thông tin đã được gửi thành công. Hồng Nhung BĐS sẽ phản hồi trong thời gian sớm nhất.</p>
  </section>

  <section class="container about-long">
    <div class="about-prose">
      <p>Quý khách có thể gọi trực tiếp hoặc nhắn Zalo để được hỗ trợ nhanh hơn.</p>
      <p>
